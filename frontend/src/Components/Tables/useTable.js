...
import { Table, TableHead, TableRow, TableCell, TablePagination, TableSortLabel } from '../materialProps';

import { tableStyle } from '../materialStyles';

function useTable(records, headCells, filterFn) {
  const classes = tableStyle();

  const pages = [5, 10, 25]; // Pages Array
